...
service StudentSrv {
     ...
     @readonly   entity GetCourses as  projection on lms.Courses;
     @readonly   entity GetContents as projection on lms.Contents{
          *,
          course : redirected to GetCourses
     };
     @readonly   entity GetEnrollments as projection on lms.Enrollments{
          *,
          course: redirected to GetCourses,
          student : redirected to GetStudents
     };
